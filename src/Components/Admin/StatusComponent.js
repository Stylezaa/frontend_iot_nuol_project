  ...
  if (status === "Online") {
    textStatus = <>
      <div className="px-4 flex items-center	border-emerald-500 border-2 w-40 rounded-full bg-emerald-400">
        <span className="w-full text-center font-sm">ONLINE</span>
      </div>
    </>;
  } else {
    textStatus = <>
      <div className="px-4 flex items-center	border-red-500 border-2 w-40 rounded-full bg-red-400">
        <span className="w-full text-center font-sm flex justify-center items-center animate-pulse text-white">OFFLINE
