...
function DetailsView(props) {
    ...
    return (
        <div className={`bg-white shadow-lg rounded fixed left-4 right-4 bottom-0 ${open ? 'top-[70%]': ' top-1/2'} top: lg:w-100 lg:fixed lg:top-0 lg:right-0 lg:left-2/3 lg:bottom-0 z-40 overflow-y-auto`}>
